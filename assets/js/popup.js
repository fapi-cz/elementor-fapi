;(function ($) {
     ...
     * Plugin API
     */
    $.fn.toretpopup = function (customoptions) {
        return this.each(function () {

            $el = $(this);

            if (typeof customoptions === 'object') {  // e.g. $('#popup').popup({'color':'blue'})
                var opt = $.extend({}, $.fn.toretpopup.defaults, customoptions);
                ...
                if (!($el.data('popupoptions'))) {
                    $el.data('popupoptions', $.fn.toretpopup.defaults);
                    options = $el.data('popupoptions');
                }
